        ...
        <div className="flex flex-col gap-4 max-w-lg">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex flex-col gap-1">
              <CanvasText
                text={profile?.name || "Ahmad Jutrzenka"}
          ...
          <div className="flex gap-3 mt-1">
            <a
              ...
              target="_blank"
              className="flex items-center gap-2 px-4 py-1.5 rounded-full text-sm text-[var(--text-muted)] hover:text-[var(--accent)] transition-colors"
            >
              LinkedIn
            </a>
            <a
